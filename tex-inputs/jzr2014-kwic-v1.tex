...
\setlength{\kwicStrutNoneLength}{1.2\myFontsize-0mm}
...
\setlength{\kwicStrutTopLength}{1.2\myFontsize}
...
\setlength{\kwicStrutDoubleTopLength}{2.857\myFontsize}
...
\newcommand*\kwicCircled[2]{%
  ...
  \begin{adjustbox}{trim=0 3.5mm 0 0}%
    \tikz[baseline=(char.base),line width=0.155mm,#1]{%
      \node[shape=circle,draw,inner sep=0.25mm,fill=white] (char) {%
...
% \usepackage{pstricks}
% \newcommand\circled[1]{%
%   \pscirclebox[boxsep=true]{\makebox[\kwicStrutTopLength]{\kwicStrutTop}\smash{#1}}%
%   }
