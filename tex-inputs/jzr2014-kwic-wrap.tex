...
% ##########################################################################################################
% ##########################################################################################################
% copied from jzr2014-kwic-intro.tex
...
\newcommand{\elinesub}[1]{{%
  % lineheight in register is at 4.55993mm
  % 3.539
  \setlength{\parskip}{8.4mm}%
  ~\par
  \setlength{\parskip}{0mm}%
  #1\par
  \centering%
  \includegraphics[width=0.5\linewidth]{/Volumes/Storage/temp/french-rule-swell-dash-englische-line/swell-dash.pdf}\\%[3\baselineskip]%
  % \par%
  }}
...
\backgroundsetup{
  ...
  angle=0,
  contents={%
  \includegraphics[width=\paperwidth,height=\paperheight,trim=0mm 0mm 210mm 0mm]{/Volumes/Storage/io/jizura-datasources/data/texts/excerpt-cover/excerpt-cover.png}
  }%
}
\BgThispage
